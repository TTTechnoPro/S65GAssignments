...
public struct StatisticsState {
    ...
    public var isElevenPro: Bool = UIDevice().type.rawValue == "iPhone 11 Pro"
...
/*
 I would like to thank and credit Alessandro Ornano for his answer on this StackOverflow thread, which helped me identify the device the app was running on.
 URL: https://stackoverflow.com/questions/26028918/how-to-determine-the-current-iphone-device-model
 */
